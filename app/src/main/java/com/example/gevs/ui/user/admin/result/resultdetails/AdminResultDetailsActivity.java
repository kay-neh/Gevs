package com.example.gevs.ui.user.admin.result.resultdetails;
...
public class AdminResultDetailsActivity extends AppCompatActivity {

    ActivityAdminResultDetailsBinding binding;
    String constituency;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = DataBindingUtil.setContentView(this, R.layout.activity_admin_result_details);
        ...
        baseRepository.getDistrictVoteById(constituency).observe(this, new Observer<DistrictVote>() {
            ...
            public void onChanged(DistrictVote districtVote) {
                if (districtVote != null) {
                    baseRepository.getCandidatesByConstituency(constituency).observe(AdminResultDetailsActivity.this, new Observer<List<Candidate>>() {
                        @Override
    ...
    public void initAdapter() {
        ...
        binding.adminVoteCountRecyclerview.addItemDecoration(new CardDecoration(spacing));
